...
const FraudDetectionAgent = () => {
    ...
    const handlePostRequest = () => {
        ...
        // POST request
        axios.post('http://localhost:5000/api/SendFraudDetectionAgent', postData, {
            headers: {
    ...
    return (
        <div style={{ fontFamily: 'Arial, sans-serif', padding: '20px', maxWidth: '600px', margin: '0 auto' }}>
            <h1 style={{ textAlign: 'center', color: '#333' }}>Fraud Detection AI Agent App</h1>
            ...
            {postResponse && (
                <div style={{ padding: '10px', border: '1px solid #ccc', borderRadius: '5px', backgroundColor: '#f9f9f9' }}>
                    <h3 style={{ color: '#333' }}>Fraud Detection AI Agent Result:</h3>
